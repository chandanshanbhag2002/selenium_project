...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/testng-results">
		...
		<table style="border-collapse:collapse;border:1px solid black;width:100%" align="left">
		<thead>		
			<tr bgcolor="#eee">
				<th colspan="8" width="100%" style="padding:5px;border-collapse:collapse;border:1px solid black;">Rest Execution Report</th>
			</tr>
		</thead>
		<tbody>
			<tr style="background-color: #eaf0f7;">
				<td width="78%" style="background-color: #eaf0f7; padding: 3px 3px 3px 0;" align="center"><B>Suite Name</B></td>
				<td style="background-color: #FFBBBB; padding: 3px 3px 3px 0;" align="center"><B>Total Failed Count</B></td>
				<td style="background-color: lightgreen; padding: 3px 3px 3px 0;" align="center"><B>Total Passed Count</B></td>
				<td style="background-color: #FFFFBB; padding: 3px 3px 3px 0;" align="center"><B>Total Skipped Count</B></td>
				<td align="center" style="background-color: #eaf0f7; padding: 3px 3px 3px 0;"><B>Overall Count</B></td>
				<td align="center" style="font-weight: bold; background-color: #eaf0f7; padding: 3px 3px 3px 0;"><B>Total Pass %</B></td>
				<td align="center" style="font-weight: bold; background-color: #eaf0f7; padding: 3px 3px 3px 0;"><B>Execution Date</B></td>
				<td align="center" style="font-weight: bold; background-color: #eaf0f7; padding: 3px 3px 3px 0;"><B>Total Duration</B></td>
			</tr>
			 ...
			 <xsl:variable name="testCaseElements"
                            ...
                            <tr style="background-color: #eaf0f7;">
                                ...
                                <xsl:call-template name="percentageOverview">
									...
									<xsl:with-param name="current-date"                    
													select="current-date()"/>
								</xsl:call-template>
                    ...
                    <xsl:for-each select="$suiteElements">
						...
						<tr style="background-color: #eaf0f7;">
								<td width="37.8%" style="background-color: #808080; padding: 3px 3px 3px 0;" align="center" ><B>Module Name</B></td>
								<td width="9.5%" style="background-color: #808080; padding: 3px 3px 3px 0;" align="center"><B>Failed Count</B></td>
								<td width="9.5%" style="background-color: #808080; padding: 3px 3px 3px 0;" align="center"><B>Passed Count</B></td>
								<td width="9.5%" style="background-color: #808080; padding: 3px 3px 3px 0;" align="center"><B>Skip Count</B></td>
								<td width="13%" align="center" style="background-color: #808080; padding: 3px 3px 3px 0;"><B>Overall Count</B></td>
								<td align="center" style="font-weight: bold; background-color: #808080; padding: 3px 3px 3px 0;"><B>Pass %</B></td>
								<!--<td align="center" style="font-weight: bold; background-color: #808080; padding: 3px 3px 3px 0;"><B>Start Time</B></td>-->
								<!--<td align="center" style="font-weight: bold; background-color: #808080; padding: 3px 3px 3px 0;"><B>Duration</B></td>-->
                            </tr>
                            ...
                            <xsl:for-each select="$testCaseElements">
                                ...
                                <tr style="background-color: #f5f5f5; font-size: 12px;">
                                    <td width="37.8%" style="padding: 3px 3px 3px 0;" align="center">
                                        <xsl:value-of select="@name"/>
                                    </td>
                                    <td align="center" width="9.5%" style="padding: 3px 3px 3px 0;">
                                    ...
                                    <td align="center" style="font-weight: bold; font-weight: bold; padding: 3px 3px 3px 0;">
                                        <xsl:value-of
