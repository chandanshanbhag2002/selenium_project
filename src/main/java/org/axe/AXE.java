...
public class AXE {
	 ...
	 * 
	 * @param name
	 *            Desired filename, sans extension
	 * @param output
	 *            Object to write. Most useful if you pass in either the
	 *            Builder.analyze() response or the violations array it
	 *            contains.
	 */
...
//					new FileOutputStream(name + ".json"), "utf-8"));
	...
	public static class Builder {
		 ...
		 * 
		 * @param options
		 *            Options object as a JSON string
		 */
